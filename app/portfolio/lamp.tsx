...
const Portfolio = async ({searchParams}: Props) => {
  ...
  return (
    <div className=' overflow-y-scroll gap-5 flex flex-col  content-start items-center w-screen h-screen px-4 pt-14 box-border bg-[url(/assets/background_pink.png)] bg-cover'>
